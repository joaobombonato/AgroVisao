...
import { X, Check, ZoomIn, ZoomOut, ChevronUp, ChevronDown, ChevronLeft, ChevronRight } from 'lucide-react';
        ...
        <div className="fixed inset-0 z-[1500] bg-black/80 flex flex-col items-center justify-center p-4 backdrop-blur-sm">
            <div className="bg-white w-full max-w-sm rounded-[2.5rem] overflow-hidden shadow-2xl flex flex-col">
                ...
                <div className="p-4 bg-gray-50/80 border-t flex gap-2">
                    <button onClick={onClose} className="flex-1 py-3 text-xs font-bold text-gray-500 hover:text-gray-700 transition-colors">Cancelar</button>
                    <button onClick={onApply} className="flex-1 bg-green-600 text-white py-3 rounded-2xl font-bold shadow-lg flex items-center justify-center gap-2 hover:bg-green-700 active:scale-95 transition-all text-xs">
