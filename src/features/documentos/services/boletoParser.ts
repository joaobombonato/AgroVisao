/**
 * boletoParser.ts — Parser de Boletos Bancários
 * 
 * Extraído de barcodeIntelligence.ts.
 * Converte entre barcode(44)↔linha digitável(47), calcula valor,
 * vencimento (com tratamento do reset fev/2025) e extrai agência/conta.
 */
import type { BoletoData } from './barcodeIntelligence';
